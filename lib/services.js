...
export const facialTreatments = [
  ...
  { id:"express-facial", name:"Express Facial", duration:45, price:65, description:"A quick, refreshing facial for when you’re short on time. It begins with a gentle cleanse and skin analysis, followed by light exfoliation, steam and a warm towel. A hydrating mask and finishing products complete the treatment, leaving your skin feeling fresh, smooth, and refreshed.", includes:["Gentle cleanse & skin analysis","Light exfoliation","Steam & warm towel","Hydrating mask","Finishing skincare products","Fresh, smooth & refreshed complexion"], image:"/services/Express-Facial.jpeg" }
];
