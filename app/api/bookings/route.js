...
export async function POST(req){
 ...
 const emailResults=await Promise.allSettled([sendMail({to:normalizedEmail,subject:`Appointment Confirmed — ${business.name}`,html}),sendMail({to:business.email,subject:`New Appointment — ${business.name}`,html:owner})]);emailResults.filter(x=>x.status==="rejected").forEach(x=>console.error("BOOKING EMAIL FAILED:",x.reason));
