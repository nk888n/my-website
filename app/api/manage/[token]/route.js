...
export async function POST(req,{params}){
 try{
  ...
  if(body.action==="reschedule"){
    ...
    if(!date||startMinutes<OPEN||startMinutes%30!==0||startMinutes+Number(b.duration_minutes)>CLOSE)return NextResponse.json({error:"Please choose an available date and time."},{status:400});
